...
class Olresults_model extends CI_Model{
    ...
    public function get_olresults1($olind1 = FALSE || $yea1 = FALSE){
    ...
    public function get_olresults2($olind2 = FALSE || $yea2 = FALSE){
        ...
        $query1 = $this->db->get_where('ol_result', array('OL_index' => $olindex2,'year' => $year2 ));
    ...
    public function get_olresults3($olind3 = FALSE || $yea3 = FALSE){
        if($olind3 == NULL && isset($_SESSION['olindex3']) && !empty($_SESSION['olindex3'] && $yea1=NULL && isset($_SESSION['year3']) && !empty($_SESSION['year3']))){
            ...
            $query1 = $this->db->get_where('ol_result', array('OL_index' => $olindex3, 'year' => $year3));
